...
describe("Pool Basic", function () {
  ...
  describe("#withdrawAdminFees", async function () {
    ...
    it("withdraws admin fees with repayment at loan maturity with fee share", async function () {
      /* set admin fee */
      await pool.setAdminFee(500, accounts[2].address, 500);
      ...
      /* Fee share */
      const feeShare = adminFee.mul(500).div(10000);
      const recipientAmount = adminFee.sub(feeShare);
