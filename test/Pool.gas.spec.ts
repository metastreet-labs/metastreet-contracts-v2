...
describe("Pool Gas", function () {
  ...
  describe("#merkle", async function () {
    ...
    for (const [count, principal, numTicks, maxGas] of [
      [10, FixedPoint.from("15"), 10, 277100],
      [10, FixedPoint.from("25"), 16, 356600],
      [100, FixedPoint.from("15"), 10, 280600],
      [100, FixedPoint.from("25"), 16, 360200],
      [1000, FixedPoint.from("15"), 10, 285200],
      [1000, FixedPoint.from("25"), 16, 364800],
    ]) {
