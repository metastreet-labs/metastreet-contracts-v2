...
describe("Pool Ranged Collection", function () {
  ...
  describe("#borrow", async function () {
    ...
    it("originates loan with v1 delegation with ranged collection filter", async function () {
    ...
    it("originates loan with v2 delegation with ranged collection filter", async function () {
      /* Compute borrow options */
      const borrowOptions = ethers.utils.solidityPack(
        ["uint16", "uint16", "bytes20"],
