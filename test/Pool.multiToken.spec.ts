...
describe("Pool Multi Token", function () {
  ...
  before("deploy fixture", async () => {
    ...
    /* Deploy multi token collateral wrapper */
  ...
  describe("#quote", async function () {
    ...
    it("correctly quotes repayment for multi token", async function () {
      expect(
        await pool.quote(
          FixedPoint.from("10"),
          30 * 86400,
    ...
    it("fails on insufficient liquidity for multi token", async function () {
      await expect(
        pool.quote(
  ...
  describe("#quoteRefinance", async function () {
    ...
    it("correctly quotes refinance payment and repayment at original multi token loan maturity with same principal", async function () {
      /* Create Loan */
      const [loanReceipt] = await createActiveERC1155Loan(FixedPoint.from("25"));
    ...
    it("correctly quotes refinance payment and repayment at original multi token loan maturity with smaller principal (1 ETH less)", async function () {
      /* Create Loan */
      const [loanReceipt] = await createActiveERC1155Loan(FixedPoint.from("25"));
    ...
    it("correctly quotes refinance payment and repayment at original multi token loan maturity with bigger principal (1 ETH more)", async function () {
      /* Create Loan */
      const [loanReceipt] = await createActiveERC1155Loan(FixedPoint.from("25"));
  ...
  describe("#borrow", async function () {
    ...
    it("originates multi token loan", async function () {
      /* Mint ERC1155Wrapper */
      const mintTx = await ERC1155CollateralWrapper.connect(accountBorrower).mint(
        nft1.address,
        [123, 124, 125],
    ...
    it("originates multi token loan with delegation", async function () {
      /* Mint ERC1155Wrapper */
      const mintTx = await ERC1155CollateralWrapper.connect(accountBorrower).mint(
        nft1.address,
        [123, 124, 125],
    ...
    it("originates multi token loan for a 85 ETH principal", async function () {
      /* Mint ERC1155Wrapper */
      const mintTx = await ERC1155CollateralWrapper.connect(accountBorrower).mint(
        nft1.address,
        [123, 124, 125],
    ...
    it("fails on multi token with invalid option encoding", async function () {
      /* Mint multi token */
      const mintTx = await ERC1155CollateralWrapper.connect(accountBorrower).mint(
        nft1.address,
        [123, 124, 125],
    ...
    it("fails on insufficient liquidity with multi token", async function () {
      const mintTx = await ERC1155CollateralWrapper.connect(accountBorrower).mint(
        nft1.address,
        [123, 124, 125],
        [1, 2, 3]
  ...
  describe("#repay", async function () {
    ...
    it("repays multi token loan at maturity", async function () {
  ...
  describe("#refinance", async function () {
    ...
    it("refinance multi token loan at maturity with admin fee and same principal", async function () {
      /* Set Admin Fee */
    ...
    it("multi token loan fails on refinance and refinance in same block with same loan receipt fields", async function () {
      /* Set Admin Fee */
      pool.setAdminFeeRate(500);
    ...
    it("multi token loan fails on borrow and refinance in same block with same loan receipt fields", async function () {
    ...
    it("multi token loan fails on invalid caller", async function () {
      /* setup liquidity and borrow */
      await setupLiquidity();
      pool.setAdminFeeRate(500);
    ...
    it("multi token loan fails on invalid loan receipt", async function () {
      /* setup liquidity and borrow */
      await setupLiquidity();
      pool.setAdminFeeRate(500);
      [loanReceipt, loanReceiptHash] = await createActiveERC1155Loan(FixedPoint.from("25"));
    ...
    it("multi token loan fails on repaid loan", async function () {
      /* Set Admin Fee */
      pool.setAdminFeeRate(500);
    ...
    it("multi token loan fails on liquidated loan", async function () {
      /* Set Admin Fee */
      pool.setAdminFeeRate(500);
  ...
  describe("#liquidate", async function () {
    ...
    it("liquidates expired multi token loan", async function () {
      /* Create Loan */
      [loanReceipt, loanReceiptHash, ERC1155WrapperTokenId] = await createActiveERC1155Loan(FixedPoint.from("25"));
