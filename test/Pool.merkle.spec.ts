...
describe("Pool Merkle", function () {
  ...
  before("deploy fixture", async () => {
    ...
    const poolImplFactory = await ethers.getContractFactory("WeightedRateMerklePoolV2");
    ...
    proxy = await testProxyFactory.deploy(
      ...
      poolImpl.interface.encodeFunctionData("initialize", [
        ethers.utils.defaultAbiCoder.encode(
          ["address", "address", "uint64[]", "uint64[]", "bytes32", "uint32", "string"],
          [
            nft1.address,
            tok1.address,
  ...
  describe("#quote", async function () {
    ...
    it("correctly quotes repayment with merkle filter", async function () {
    ...
    it("fails on unsupported collateral with merkle filter", async function () {
      /* Declare an invalid merkle proof */
      const merkleProof =
        "0x3884b31e0f33131a3794d68a9e50eff8f202bbedcf8a837ffa8f02daac6d55c7fd65998deda42723bb9b4108c7a015c3ce1c178917dd7c235dec2d68de3e73dc";
