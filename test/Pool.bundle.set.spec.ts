...
describe("Pool Bundle Set Collection", function () {
  ...
  describe("#borrow", async function () {
    ...
    it("originates bundle loan with set filter", async function () {
    ...
    it("originates bundle loan with delegation and set filter", async function () {
      /* Compute borrow options */
      const borrowOptions = ethers.solidityPacked(
