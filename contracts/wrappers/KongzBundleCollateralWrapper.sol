...
contract KongzBundleCollateralWrapper is ICollateralWrapper, ERC721, ReentrancyGuard {
     ...
     */
    mapping(uint256 => uint256) _lastUpdatedTimestamps;
     ...
     */
    constructor(address cyberkongz, address banana, address yieldHub, uint256 maxTokenId) ERC721("MetaStreet CyberKongz Bundle Collateral Wrapper", "MSCKBCW") {
