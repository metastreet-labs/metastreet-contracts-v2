    ...
    ICollateralLiquidationReceiver
{
     ...
     * @inheritdoc IPool
     */
    function deposit(uint128 tick, uint256 amount, uint256 minShares) public virtual nonReentrant returns (uint256) {
    ...
    function rebalance(
        ...
        uint128 redemptionId,
        uint256 minShares
    ) public virtual nonReentrant returns (uint256, uint256, uint256) {
        /* Handle withdraw accounting and compute both shares and amount */
