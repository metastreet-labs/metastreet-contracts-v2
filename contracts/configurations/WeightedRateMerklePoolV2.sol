 ...
 */
contract WeightedRateMerklePoolV2 is Pool, WeightedInterestRateModel, MerkleCollateralFilter {
    /**************************************************************************/
    /* State */
    /**************************************************************************/
    ...
    function initialize(bytes memory params) external {
        ...
        MerkleCollateralFilter._initialize(collateralToken_, abi.encode(merkleRoot_, nodeCount_, metadataURI_));
    }
    ...
    function IMPLEMENTATION_NAME() external pure override returns (string memory) {
        return "WeightedRateMerklePoolV2";
    }
}
