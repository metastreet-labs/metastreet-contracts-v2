    ...
    ExternalPriceOracle
{
    ...
    constructor(
        ...
        WeightedInterestRateModel()
        NodePassCollateralFilter(yieldPassFactory)
    ...
    function initialize(bytes memory params) external {
        ...
        NodePassCollateralFilter._initialize(nodeToken_);
    ...
    function IMPLEMENTATION_NAME() external pure override returns (string memory) {
        return "WeightedRateYieldPassCollectionPool";
    }
}
