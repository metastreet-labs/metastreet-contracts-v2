 ...
 */
contract WeightedRateMerkleCollectionPool is Pool, WeightedInterestRateModel, MerkleCollateralFilter {
    /**************************************************************************/
    /* State */
    /**************************************************************************/
    ...
    function initialize(bytes memory params) external {
        ...
        MerkleCollateralFilter._initialize(collateralToken_, merkleRoot_, nodeCount_, metadataURI_);
    }
