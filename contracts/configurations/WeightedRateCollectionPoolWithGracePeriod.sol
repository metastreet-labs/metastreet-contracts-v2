 ...
 * Collateral Filter with Grace Period
 * @author MetaStreet Labs
 */
contract WeightedRateCollectionPoolWithGracePeriod is
    Pool,
    ...
    ExternalPriceOracle
{
    ...
    function initialize(bytes memory params) external {
        ...
        ) = abi.decode(params, (address[], address, address, uint64[], uint64[], uint256, uint256));
    ...
    function IMPLEMENTATION_NAME() external pure override returns (string memory) {
        return "WeightedRateCollectionPoolWithGracePeriod";
    }
