...
library BorrowLogic {
     ...
     * receipt hash, fee share amount
     */
    function _repay(
        Pool.PoolStorage storage self,
        bytes calldata encodedLoanReceipt,
        Pool.FeeShareStorage memory feeShareStorage
    ) external returns (uint256, LoanReceipt.LoanReceiptV2 memory, bytes32, uint256) {
        ...
        return (repayment, loanReceipt, loanReceiptHash, feeShareAmount);
    }
