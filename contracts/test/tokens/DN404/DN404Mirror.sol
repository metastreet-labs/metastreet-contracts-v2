...
contract DN404Mirror {
    ...
    function totalSupply() public view virtual returns (uint256 result) {
        ...
        assembly {
            ...
            if iszero(and(gt(returndatasize(), 0x1f), staticcall(gas(), base, 0x1c, 0x04, 0x00, 0x20))) {
    ...
    function balanceOf(address owner) public view virtual returns (uint256 result) {
        ...
        assembly {
            ...
            if iszero(and(gt(returndatasize(), 0x1f), staticcall(gas(), base, 0x1c, 0x24, 0x00, 0x20))) {
                returndatacopy(mload(0x40), 0x00, returndatasize())
                revert(mload(0x40), returndatasize())
            }
            result := mload(0x00)
    ...
    function approve(address spender, uint256 id) public virtual {
        ...
        assembly {
            ...
            mstore(0x40, id)
            mstore(0x60, caller())
            if iszero(and(gt(returndatasize(), 0x1f), call(gas(), base, callvalue(), 0x1c, 0x64, 0x00, 0x20))) {
        ...
        if (fnSelector == 0x263c69d6) {
            ...
            assembly {
                ...
                for {} iszero(eq(o, end)) { o := add(0x20, o) } {
                    ...
                    log4(
                        codesize(), 0x00, _TRANSFER_EVENT_SIGNATURE, mul(a, b), mul(a, iszero(b)), shr(168, shl(160, d))
                    )
                }
                mstore(0x00, 0x01)
                return(0x00, 0x20)
